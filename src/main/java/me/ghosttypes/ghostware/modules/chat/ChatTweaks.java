...
import me.ghosttypes.ghostware.utils.chat.Emotes;
...
public class ChatTweaks extends Module {
    ...
    public final Setting<String> prefixText = sgGeneral.add(new StringSetting.Builder().name("custom-prefix-text").description("Override the [Ghostware] prefix.").defaultValue("Ghostware").visible(customPrefix :: get).build());
    ...
    public ChatTweaks() {
        super(Categories.Chat, "better-chat-plus", "Various chat improvements.");
    }


    @Override
    public void onActivate() {
        ChatUtils.registerCustomPrefix("me.ghosttypes.ghostware", this::getPrefix);
    }
