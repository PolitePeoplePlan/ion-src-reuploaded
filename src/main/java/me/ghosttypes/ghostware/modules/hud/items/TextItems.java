package me.ghosttypes.ghostware.modules.hud.items;
...
public class TextItems extends HudElement {
    ...
    private void updateCounter() {
        itemCounter.clear();
        for (Item item: items.get()) if (!(item instanceof BedItem)) itemCounter.add(InvUtil.getCommonName(item) + ": " + InvUtils.find(item).getCount());
