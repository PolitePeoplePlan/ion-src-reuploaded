package me.ghosttypes.ghostware.modules.misc.elytrabot;
...
import me.ghosttypes.ghostware.modules.misc.elytrabot.utils.*;
...
public class ElytraBotThreaded extends Module {
    ...
    public ElytraBotThreaded() {
        super(Categories.Misc, "elytra-bot", "Elytra AutoPilot");
    }
    ...
    public void onActivate() {
        ...
        if (mc.player.getEquippedStack(EquipmentSlot.CHEST).getItem() != Items.ELYTRA) {
            ...
            if (elytra.found()) InvUtils.move().from(elytra.getSlot()).toArmor(2);
        }
    ...
    public void loop() {
        ...
        if (flyMode.get() == FlyMode.Firework && InvUtils.find(Items.FIREWORK_ROCKET).getCount() == 0) {
